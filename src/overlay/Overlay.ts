...
export default class Overlay {
    ...
    private innerStartX = 800 - 118 // gameWidth (800) - rectangle width (118)
  ...
  public updateTimer () {
    const text = 'time' //this.scene.timer.getFormated()
  ...
  private addRectangle () {
    ...
    this.graphicsRectangle = graphics
      ...
      .setDepth(this.depths.overlayRectangle)
  }
